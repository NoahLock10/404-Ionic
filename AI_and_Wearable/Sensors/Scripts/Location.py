...
def GPS_Info():
    ...
    try:
        ...
        lat_in_degrees = "30.628" #convert latitude into decimal format
        long_in_degrees = "96.334" #convert longitude into decimal format
...
file1 = open('/home/pi/ECEN404/Sensors/Data/location.txt', 'w'); #writing the data to GPSData.txt
