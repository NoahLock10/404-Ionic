...
def makeMelSpec(fileName):
    filePath = "/home/pi/ECEN404/Pipeline/Scripts/melspec_files/" + fileName + ".png"
    myFile = Path(filePath)
    
    y, sr = librosa.load("/home/pi/ECEN404/Sensors/Data/audio.wav")
...
def cutAll(filePath, fileName, type):
    ...
    if (samples >= 1):
        for i in range(samples - 1):
            ...
            try:
                cutSong(song, startTime, endTime, i, name.replace(".WAV", ""), type, "/home/pi/ECEN404/Sensors/Data/") 
